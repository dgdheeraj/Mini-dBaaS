...
def create_new_ride():
    ...
    x = requests.post('http://orchestrator:80/api/v1/db/write', json=body)
    return {},201
...
def list_all_rides():
    ...
    r=requests.post("http://orchestrator:80/api/v1/db/read",json=data)
...
def join_ride(ride_id):
    ...
    r=requests.post("http://orchestrator:80/api/v1/db/write",json=data)
    return {},201
...
def rem_ride(ride_id):
    ...
    x = requests.post('http://orchestrator:80/api/v1/db/read', json=body1)
    if len(json.loads(x.text))==0:return {},400
    x = requests.post('http://orchestrator:80/api/v1/db/write', json=body2)
    return {},200
...
def ride_count():
    ...
    x = requests.post('http://orchestrator:80/api/v1/db/read', json=body)
    l1=json.loads(x.text)
    n = len(l1)
